                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li><Link to="/corporate-services" >Company Secretarial Services</Link></li>
                                    <li><Link to="/corporate-services" >Statutory Registrations</Link></li>
                                    <li><Link to="/corporate-services" >Corporate Training</Link></li>
                                    <li><Link to="/Trainings" >Entrepreneurship Training</Link></li>
                                    <li><Link to="/corporate-services" >Virtual Office Services</Link></li>
                                    <li><Link to="/corporate-services" >Consultancy Services</Link></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li><Link to="/Trainings" >Training Programs</Link></li>
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex gap-6 text-sm">
                                <Link to="/privacy-policy" className="text-gray-400 hover: transition-colors">Privacy Policy</Link>
                                <Link to="/terms-of-service" className="text-gray-400 hover: transition-colors">Terms of Service</Link>
                                <Link to="/compliance" className="text-gray-400 hover: transition-colors">Compliance Standards</Link>
                            </div>
                        </div>
                    </div>
                </div>
