...
import { BookOpen, Calendar, Clock, Users, Award, CheckCircle, ArrowRight } from "lucide-react"
import { TrainingTypeInterface } from "~/components/interface"
import trainingTypeController from "~/controllers/trainingType"
import RootLayout from "~/Layout/PublicLayout"

export default function TrainingsPage() {
    const { trainingTypes } = useLoaderData<{ trainingTypes: TrainingTypeInterface[] }>()
...
export const loader: LoaderFunction = async ({ request }) => {
    try {
        const { trainingTypes } = await trainingTypeController.GetActiveTrainingTypes();
