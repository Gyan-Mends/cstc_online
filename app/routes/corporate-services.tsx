                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                            {[
                                ...
                                <ScrollAnimation key={index} delay={service.delay}>
                                    <div className="h-full rounded-lg lg:h-[40vh] border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md flex flex-col justify-between">
                                        <div>
